...
const Warning = ({ t, title, description, Custom }: AlertToast) => {
  return (
    <div className="dark:bg-primary-dark relative h-full w-80 overflow-hidden rounded-lg bg-white shadow-lg ring-1 ring-gray-300 dark:shadow-2xl dark:ring-white/5">
      {/* pattern */}
      <Grid
        width={20}
        height={20}
      ...
      <div className="relative flex w-full items-start justify-between overflow-hidden rounded-lg">
        <div className="flex w-full items-start justify-start gap-2 p-3 pt-2 pb-4">
          <VscWarning className="mt-1 size-4 shrink-0 text-amber-700" />
