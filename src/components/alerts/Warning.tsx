...
const Warning = ({ t, title, description, Custom }: AlertToast) => {
  ...
  return (
    <div
      ...
      className="dark:bg-primary-dark relative h-full min-w-full overflow-hidden rounded-xl bg-white shadow-md ring-1 shadow-amber-700/10 ring-amber-700/10 @xl:w-80"
    >
      {/* pattern */}
      <Grid
        width={20}
      ...
      <div className="relative flex items-start justify-between overflow-hidden rounded-lg">
        <div className="flex items-center justify-start gap-3 p-3 py-4">
          <div className="flex h-full flex-1 items-center justify-center rounded-lg bg-amber-700 p-1 text-white">
            <IoAlertCircle className="size-8" />
          </div>

          <div>
            <h3 className="text-base font-medium text-amber-700">{title}</h3>
