...
const Switch = ({
  ...
  return (
    ...
    >
      <span
        className={cn(
          "group-data-[selected]:bg-primary h-7 w-10 cursor-pointer rounded-full border-2 border-transparent bg-gray-200 ring-offset-2 ring-offset-inherit transition duration-200 group-data-[disabled=true]:pointer-events-none group-data-[disabled=true]:opacity-40 group-data-[focus-visible]:ring-2 dark:bg-white/30",
          switchClass,
        )}
      >
