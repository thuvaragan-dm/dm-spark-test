...
const MaintenanceMode = ({
  title = "We are currently in maintenance mode",
  message = "Our team is working hard to improve Spark. We will be back online shortly. Thank you for your patience.",
}: {
  title?: string;
  message?: string;
}) => {
    ...
    <div className="relative flex h-dvh w-full flex-col overflow-hidden">
      ...
      <div className="relative z-50 grid w-full flex-1 grid-cols-7 overflow-hidden p-10">
        ...
        <div className="items-start-safe scrollbar col-span-3 flex w-full flex-1 flex-col justify-center-safe overflow-y-auto pl-20">
          ...
          <p className="mt-5 max-w-sm text-base text-white/80">{message}</p>
        </div>
        {/* form */}
      </div>
