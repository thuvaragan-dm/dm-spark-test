...
const ReConnectionModal = ({
  ...
  const { mutateAsync: updateMCPConnection, isPending: isUpdatingConnection } =
    useUpdateMCPConnection({
      invalidateQueryKey: [mcpKey[EMCP.FETCH_MCP_CONNECTION_DETAIL]],
    });
  ...
  const handleOAuthSubmit = useCallback(
    ...
    [updateMCPConnection, connectionId, serviceProvider, handleSuccess],
  );
