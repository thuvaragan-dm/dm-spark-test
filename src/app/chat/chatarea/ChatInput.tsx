...
const ChatInput = forwardRef<ChatInputHandle, IChatInput>(
  (
    {
      handleSubmit,
      openExplorer,
    ...
    const scrollAndFocus = () => {
      if (textAreaRef.current) {
        ...
        setTimeout(() => {
          ...
          console.log("Scrolled to bottom, cursor moved to end");
        }, 300);
      }
    };

    useImperativeHandle(ref, () => ({
      scrollToBottom: scrollAndFocus,
    }));
