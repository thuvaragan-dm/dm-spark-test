import { Source, Suggestion, Video } from "../../../api/messages/types"; // Assuming this path is correct relative to MessageHandler.ts
import { apiUrl } from "../../../api/variables"; // Assuming this path
...
export interface StreamDataAccumulator {
  ...
  files: File[]; // As per your MessageHandler structure
}
