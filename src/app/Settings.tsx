...
export const SettingsModal = ({
  ...
  return (
    <Modal
      ...
      Trigger={() => <></>}
    >
      <div className="flex w-full flex-col items-start justify-start divide-gray-300 overflow-hidden border-t border-gray-100 px-3 pt-5 md:h-full md:flex-row md:divide-x dark:divide-white/10 dark:border-white/10">
        {/* left section */}
        ...
        {!isUserLoading && user && (
          ...
          >
            <SlidingContainer
              active={activeTab}
              wrapperClass="w-full flex-1 flex flex-col overflow-hidden"
              className="scrollbar mt-5 flex w-full flex-1 flex-col overflow-y-auto pr-1 pb-5 md:mt-0 md:pl-5"
            >
              {activeTab === ActiveTab.PROFILE && (
                    ...
                    <div className="flex w-full items-start justify-between gap-5">
                      <div className="">
                        ...
                        <p className="max-w-sm text-xs text-gray-500 dark:text-white/60">
                          ...
                          change it now. Didn&apos;t request this? Contact
                          support.
                        </p>
                      </div>
