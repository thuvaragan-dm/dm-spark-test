      ...
      <div className="grid w-full flex-1 grid-cols-6 overflow-hidden @6xl:grid-cols-7">
        ...
        <div className="items-start-safe col-span-3 flex w-full flex-1 flex-col justify-center-safe overflow-y-auto pl-20">
          ...
          <div className="mt-10 w-full max-w-xs">
            <Button
              onClick={() => {
                const signInUrl = "https://copilots.deepmodel.ai/desktop-app";
                if (window.ipcRenderer && window.ipcRenderer.send) {
                  // Send a message to the main process to open the URL
                  window.ipcRenderer.send("open-external-url", signInUrl);
                }
              }}
              wrapperClass="w-full"
              className={"w-full"}
            ...
            <p className="mt-10 max-w-60 text-[0.65rem] text-gray-600 dark:text-white/50">
              ...
              <a
                onClick={(e) => {
                  ...
                  window.ipcRenderer.send("open-external-url", privacyUrl);
                }}
        ...
        {/* illustration */}
        <div className="col-span-3 flex w-full flex-1 items-center justify-end overflow-hidden p-10 @6xl:col-span-4">
          <svg
          ...
          >
            <circle
              ...
              cy={227}
              r={227}
              fill="url(#paint0_linear_275_1352)"
            />
            <path
